...
comments_dataframe_path = './data/comments_dataframe.csv'
...
comments_dataframe = pd.DataFrame(columns=['Cate', 'Author', 'Text','Score'])
...
corpus = CorpusFromParsedDocuments(comments_dataframe, category_col='Cate', parsed_col='Text').build()
